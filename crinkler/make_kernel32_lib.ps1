...
$entries = @(
    ...
    @("USER32.DLL",   "_RegisterClassExW@4"),
    @("USER32.DLL",   "_CreateWindowExW@48"),
    @("USER32.DLL",   "_FindWindowW@8"),
    @("USER32.DLL",   "_SetWindowPos@28"),
    @("USER32.DLL",   "_GetWindowRect@8"),
    @("USER32.DLL",   "_TrackMouseEvent@4"),
    @("USER32.DLL",   "_GetCursorPos@4"),
    @("USER32.DLL",   "_LoadCursorW@8"),
    @("USER32.DLL",   "_GetWindowLongW@8"),
    @("USER32.DLL",   "_SetWindowLongW@12"),
    @("USER32.DLL",   "_SetParent@8"),
    @("USER32.DLL",   "_GetClientRect@8"),
    @("USER32.DLL",   "_GetDpiForWindow@4"),
    @("USER32.DLL",   "_keybd_event@16"),
    @("USER32.DLL",   "_SetCapture@4"),
    @("USER32.DLL",   "_ReleaseCapture@0"),
    @("USER32.DLL",   "_SetTimer@16"),
    @("USER32.DLL",   "_CreatePopupMenu@0"),
    @("USER32.DLL",   "_AppendMenuA@16"),
    @("USER32.DLL",   "_TrackPopupMenu@28"),
    @("USER32.DLL",   "_DestroyMenu@4"),
